...
title = '        ・          GANG DISCORD HACK            ・           Made by ! ・Martin#9693'
...
def spammer():
    ...
    print(f'                                     | $$  \ $$| $$  | $$| $$\  $$$| $$  \ $$')
    print(f'                                     |  $$$$$$/| $$  | $$| $$ \  $$|  $$$$$$/')
    print(f'{Fore.WHITE}> Made by! ・Martin#9693{Fore.RESET}              {Fore.LIGHTMAGENTA_EX}\______/ |__/  |__/|__/  \__/ \______/')
    print(f'{Fore.WHITE}> https://github.com/1xMartin{Fore.RESET}') 
